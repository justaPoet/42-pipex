...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   gestion_error_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: apoet <apoet@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/07 22:47:47 by febouana          #+#    #+#             */
/*   Updated: 2024/07/17 17:44:01 by apoet            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	gestion_error(int type)
{
	...
	if (type == 3)
		write(2, "\033[1;31m$> ./pipex here_doc LIMITER cmd1 cmd2 file\n\033[0m", 
		ft_strlen("\033[1;31m$> ./pipex here_doc LIMITER cmd1 cmd2 file\n\033[0m"));
	exit(EXIT_FAILURE);
}
